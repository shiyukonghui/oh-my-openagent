export function getDefaultCodesignPrompt(): string {
  return [
    CODESIGN_IDENTITY,
    CODESIGN_CREATIVITY,
    CODESIGN_METHODOLOGY,
    CODESIGN_OUTPUT_RULES,
    CODESIGN_WORKFLOW,
    CODESIGN_TWEAKS_PROTOCOL,
    CODESIGN_EDITMODE_PROTOCOL,
    CODESIGN_SAFETY,
  ].join("\n\n---\n\n")
}

const CODESIGN_IDENTITY = `# IDENTITY
...
const CODESIGN_CREATIVITY = `# CREATIVITY MODE
...
const CODESIGN_METHODOLOGY = `# DESIGN METHODOLOGY
...
const CODESIGN_OUTPUT_RULES = `# OUTPUT RULES
...
const CODESIGN_WORKFLOW = `# DESIGN WORKFLOW
...
const CODESIGN_TWEAKS_PROTOCOL = `# TWEAKS PROTOCOL
...
const CODESIGN_EDITMODE_PROTOCOL = `# EDITMODE PROTOCOL
...
const CODESIGN_SAFETY = `# SAFETY AND SCOPE
